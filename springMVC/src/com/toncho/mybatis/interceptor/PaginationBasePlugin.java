package com.toncho.mybatis.interceptor;
...
import com.toncho.dao.PageCondition;
import com.toncho.dao.PageHolder;
...
public abstract class PaginationBasePlugin implements Interceptor {
	...
	private static final Logger log = Logger.getLogger(PaginationBasePlugin.class);
